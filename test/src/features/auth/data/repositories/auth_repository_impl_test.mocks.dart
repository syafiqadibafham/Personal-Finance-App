...
// in personal_finance_app/test/src/features/auth/data/repositories/auth_repository_impl_test.dart.
...
class MockAuthRemoteDataSource extends _i1.Mock implements _i3.AuthRemoteDataSource {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthLocalDataSource extends _i1.Mock implements _i5.AuthLocalDataSource {
  ...
  @override
  T? read<T extends Object?>({required String? key}) => (super.noSuchMethod(Invocation.method(
        #read,
        [],
        {#key: key},
      )) as T?);
