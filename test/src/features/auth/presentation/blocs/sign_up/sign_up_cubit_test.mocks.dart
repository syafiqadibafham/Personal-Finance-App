...
// in personal_finance_app/test/src/features/auth/presentation/blocs/sign_up/sign_up_cubit_test.dart.
...
import 'package:personal_finance_app/src/features/auth/domain/use_cases/sign_up_use_case.dart' as _i4;
...
class MockSignUpUseCase extends _i1.Mock implements _i4.SignUpUseCase {
  ...
  @override
  _i5.Future<_i3.AuthUser> call(_i4.SignUpParams? params) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [params],
        ),
